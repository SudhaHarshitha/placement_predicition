...
# Configuration
# -------------------------------
DATASET_PATH = DATASET_PATH = r"C:\Users\harsh\PycharmProjects\placement_predicition\dataset\placement_predict_50K_Raw.csv"  # Change to your dataset name
OUTPUT_FOLDER = OUTPUT_FOLDER =r"C:\Users\harsh\PycharmProjects\placement_predicition\outputs\EDA_Analysis_outputs"
...
# -------------------------------
categorical_columns = df.select_dtypes(include=['object', 'string', 'category', 'bool']).columns
